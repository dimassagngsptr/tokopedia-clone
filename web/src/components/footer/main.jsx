...
import foot_logo from "../../assets/register_new.png";
   ...
   return (
      <footer className="relative w-full mt-[100px]">
         <div className="w-full px-8 mx-auto max-w-7xl">
            ...
            <div className="flex flex-col items-center justify-center w-full py-12 border-t border-blue-gray-50 md:flex-row md:justify-between">
               <p className="block mb-4 font-sans text-sm antialiased font-normal leading-normal text-center text-blue-gray-900 md:mb-0">
                  © {year}{" "}
                  <a href="https://material-tailwind.com/">Tokopedia</a>. All
                  Rights Reserved.
               </p>
